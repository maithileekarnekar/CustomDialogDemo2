package com.androidwavelength.customdialogdemo2;
...
public class MainActivity extends AppCompatActivity {
    ...
    private class BtnEditTextClickListener implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            //textEditorDialog.setOnTextEditedListener(new MyOnTextEdited Listener());
            textEditorDialog.setOnTextEditedListener(new TextEditorDialog.OnTextEditedListener() {
                @Override
